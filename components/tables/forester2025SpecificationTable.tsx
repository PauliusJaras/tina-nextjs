export default function Forester2025SpecificationTable() {
  return (
    <div className="w-[90vw] overflow-x-auto text-xs md:w-[85vw] md:text-base 3xl:w-[50vw]">
      ...
      >
        <p>*1 Degalų sąnaudos ir CO2 kiekis: pagal EB 715/2007 – EU2023/443</p>
        <p>*2 Išorės triukšmas pagal UN R51-03 S9</p>
